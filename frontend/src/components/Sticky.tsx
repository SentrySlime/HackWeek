    ...
    <div className="sticky top-0 w-screen bg-slate-50">
      <div className="flex justify-between">
        ...
        <div className="flex justify-center w-[600px]">
          <input className="flex border justify-items-center border-black w-full h-7 mt-6 rounded" type="text" placeholder="Search"/>
        </div>


        <div className="flex justify-between w-72">
        <button className="flex justify-center items-center w-28 h-8 border border-lime-600 rounded mt-4 mr-4">
            Post ﹢
          </button>
